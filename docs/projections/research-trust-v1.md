...
Initial trust is 70 and initial risk is 10. `JOB_ACCEPTED` adds 4 trust. `DISPUTE_OPENED` adds 8 risk. A finalized GenLayer judgment applies: satisfied +5 trust/-5 risk; partially satisfied -5/+8; failed -15/+20; fraudulent -30/+45 and one fraud incident. `AGENT_CLEARED` adds 10 trust and removes 20 risk.
